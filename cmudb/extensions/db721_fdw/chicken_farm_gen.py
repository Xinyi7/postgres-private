...
def main():
    ...
    with open(db721_file_farms, "wb") as f:
        ...
        serializer.write_col("Farm Name", "str", [farm.farm_name for farm in all_farms])
        ...
        serializer.write_col("Min Age Weeks", "float", [farm.min_age_weeks for farm in all_farms])
        serializer.write_col("Max Age Weeks", "float", [farm.max_age_weeks for farm in all_farms])
    ...
    with open(db721_file_chickens, "wb") as f:
        ...
        serializer.write_col("Farm Name", "str", [chicken.farm_name for chicken in chickens])
        serializer.write_col("Weight Model", "str", [chicken.weight_model for chicken in chickens])
        serializer.write_col("Sex", "str", [chicken.sex for chicken in chickens])
        serializer.write_col("Age (weeks)", "float", [chicken.age_weeks for chicken in chickens])
        serializer.write_col("Weight (g)", "float", [chicken.weight_grams for chicken in chickens])
